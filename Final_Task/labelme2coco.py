...
class labelme2coco(object):
    ...
    def data_transfer(self):
        for num, json_file in tqdm(enumerate(self.labelme_json)):
            ...
            with open(json_file, "r") as fp:
                ...
                image = self.image2(data, num, json_file)
                if image:
        ...
        # Sort all text labels so they are in the same order across data_prep splits.
        self.label.sort()
    ...
    def image2(self, data, num, json_file):
        image_dict = dict()
        dir_path = os.path.dirname(json_file)
        image_path = os.path.join(dir_path, data["imagePath"])
        if os.path.exists(image_path):
            ...
            image_dict["id"] = num
            image_dict["file_name"] = data["imagePath"]
    ...
    def save_json(self):
        ...
        keys = self.data_coco.keys()
        values = self.data_coco.values()
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="labelme annotation to coco data_prep json file."
    )
    parser.add_argument(
        "--labelme_images",
