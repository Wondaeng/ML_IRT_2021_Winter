...
def register_datasets(conf, init=False):
    ...
    os.system('python labelme2coco.py ./datasets/train --output ./datasets/json/train.json')
    os.system('python labelme2coco.py ./datasets/test --output ./datasets/json/test.json')
